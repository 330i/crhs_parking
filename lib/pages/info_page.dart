      ...
      body: StreamBuilder(
        ...
        builder: (context, snapshot) {
          if(!snapshot.hasData) {
            ...
            if(documentSnapshot['spotuid']=='none') {
              return Scaffold(
                body: Container(
                  child: Column(
                    children: [
                        ...
                        child: Center(
                          child: Column(
                            children: <Widget>[
                              ...
                              Text(
                                'Welcome ${documentSnapshot['displayName'].toString().substring(0, documentSnapshot['displayName'].toString().indexOf(' '))}',
                                style: TextStyle(
                                  color: Colors.white,
                                  fontSize: 20,
              ...
              return FutureBuilder(
                future: FirebaseFirestore.instance.collection('spots').doc(documentSnapshot['spotuid']).get(),
                builder: (context, spotDocument) {
                  if(spotDocument.hasData) {
                    DocumentSnapshot spotData = spotDocument.data as DocumentSnapshot;
                    if(!spotData['completed']) {
                      return Scaffold(
                        body: Container(
                          child: ListView(
                            children: [
                                  ...
                                  child: Column(
                                    children: [
                                      GestureDetector(
                                        ...
                                        onTap: () {
                                          DocumentReference spotRef = FirebaseFirestore.instance.collection('spots').doc(documentSnapshot['spotuid']);
                                          Navigator.of(context).push(
                                      ...
                                      Container(
                                        ...
                                        child: Column(
                                          children: <Widget>[
                                            ...
                                            (spotData['submitDate'] as Timestamp).toDate().add(Duration(days: 30+(7-(spotData['submitDate'] as Timestamp).toDate().add(Duration(days: 30)).weekday))).difference(DateTime.now()).inDays>0 ? Column(
                                              children: <Widget>[
                                                RichText(
                                                  text: TextSpan(
                                            ...
                                            (spotData['submitDate'] as Timestamp).toDate().add(Duration(days: 30+(7-(spotData['submitDate'] as Timestamp).toDate().add(Duration(days: 30)).weekday))).difference(DateTime.now()).inDays>0 ? Container(
                                              width: 200,
                                              child: Text(
                                              ...
                                              children: <Widget>[
                                                ...
                                                Row(
                                                  children: <Widget>[
                                                    ...
                                                    Text(
                                                      spotData['isCash'] ? 'Cash' : 'Check',
                                                      style: TextStyle(
                                                        color: spotData['isCash'] ? Colors.green : Colors.blue,
                                                        fontSize: 20,
                                                        fontWeight: FontWeight.w600,
                                                      ),
                                                    ),
